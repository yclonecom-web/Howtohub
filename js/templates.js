/* ============================================
   HOWTOHUB — Content Templates System
   Pre-built templates for content creation
   ============================================ */
...
const CONTENT_TEMPLATES = {
  ...
  'before-after': {
    ...
    description: 'Show transformation with comparison slides',
    defaults: {
      type: 'carousel',
      title: '',
      body: 'Swipe through to see the transformation!',
      direction: 'left',
      tags: ['Design']
    }
  },
...
function getTemplate(key) {
  return CONTENT_TEMPLATES[key] || null;
}
...
function getAllTemplates() {
  return Object.entries(CONTENT_TEMPLATES).map(([key, tmpl]) => ({
    key,
    ...tmpl
  }));
}
...
/**
 * Apply a template — returns the defaults object
 */
...
if (typeof window !== 'undefined') {
  window.CONTENT_TEMPLATES = CONTENT_TEMPLATES;
